...
public class ExcelUtils {
	...
	public static String getCellData(String xlfile, String xlsheet, int rownum, int colnum) throws IOException {
		...
		try {
			...
			//Method 1 - to read and get the data
			//data= cell.toString();
			
			//Method 2 - to read and get the data
			DataFormatter formatter = new DataFormatter();
			data = formatter.formatCellValue(cell);		//Return the formatted value of the cell as a string regardless of the cell type 
		}
		catch(Exception e){
			data ="";
		}
